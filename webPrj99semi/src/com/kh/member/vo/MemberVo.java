...
public class MemberVo {
	...
	//회원가입 시 사용하는 생성자
	public MemberVo(String memberId, String memberPwd, String memberPwd2, String memberName, String memberPhone, String memberEmail, String memberAddr, String memberInterest) {
		this.id = memberId;
		this.pwd = memberPwd;
	...
	public MemberVo(String id, String pwd, String name, String phone, String email, String addr, String interest) {
		super();
		this.id = id;
		this.pwd = pwd;
		this.name = name;
